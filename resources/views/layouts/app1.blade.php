      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="{!! asset('app-assets/images/logo/cursos-logo-light.png')!!}" data-expand="{!! asset('app-assets/images/logo/cursos-logo-light.png')!!}" data-collapse="{!! asset('app-assets/images/logo/cursos-logo-small.png')!!}" class="brand-logo"></a></li>
