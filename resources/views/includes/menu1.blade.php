            ...
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class=" nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Gestión</span></a>
                    <ul class="menu-content">
                        <li @if(request()->is('cursos')) class="active" @endif><a href="{{ url('/cursos') }}" data-i18n="nav.dash.main" class="menu-item">Nuevos Cursos</a>
                        </li>
                        <li @if(request()->is('listcursos')) class="active" @endif><a href="{{ url('/listcursos') }}" data-i18n="nav.dash.main" class="menu-item">Lista de Cursos</a>
                        </li>
                        <li @if(request()->is('aulas')) class="active" @endif><a href="{{ url('/aulas') }}" data-i18n="nav.dash.main" class="menu-item">Aulas</a>
                        </li>
                        <li @if(request()->is('alumnos')) class="active" @endif><a href="{{ url('/alumnos') }}" data-i18n="nav.dash.main" class="menu-item">Alumnos</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="icon-briefcase4"></i><span data-i18n="nav.project.main" class="menu-title">Administración</span></a>
                    <ul class="menu-content">
                        ...
                        <li @if(request()->is('usuarios')) class="active" @endif><a href="{{ url('/usuarios') }}" data-i18n="nav.gallery_pages.gallery_grid" class="menu-item">Usuarios</a>
                        </li>
                        <li @if(request()->is('profesores')) class="active" @endif ><a href="{{ url('/profesores') }}" data-i18n="nav.search_pages.search_page" class="menu-item">Profesores</a>
                        </li>
