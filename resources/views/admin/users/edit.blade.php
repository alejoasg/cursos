                                        ...
                                        <div class="col-md-6 offset-md-3">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="eventInput2" class="form-control" placeholder="apellido usuario" name="apellido"  value="{{old('apellido'),$user['lastname']}}">
                                                </div>
                                                <div class="form-group">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="url('/usuarios/{{$user['id']}}')"  class="btn btn-sm btn-primary" title="Editar">
